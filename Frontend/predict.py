...
file = open('/app/medical-health-buddy/Dataset/diseases.txt', encoding='utf-8')
...
pickle_in = open("/app/medical-health-buddy/Models/model_lr.pkl","rb")
model_lr = pickle.load(pickle_in)

pickle_in = open("/app/medical-health-buddy/Models/model_knn.pkl","rb")
model_knn = pickle.load(pickle_in)

pickle_in = open("/app/medical-health-buddy/Models/model_dt.pkl","rb")
model_dt = pickle.load(pickle_in)

model_dl = keras.models.load_model("/app/medical-health-buddy/Models/model_dl.keras")
